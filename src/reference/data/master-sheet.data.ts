/**
 * Option lists extracted from the SuperOffer master data sheet:
 * https://docs.google.com/spreadsheets/d/1C4u0rYMcAD9j6JToiIIMvyOUQs-sE9RyzUWMJ0K4AzM (tab gid=0)
 *
 * GENERATED FILE — regenerate rather than hand-editing when the sheet changes.
 *
 * MBBS_ONLY_COUNTRIES is the leading block of the sheet's destination column
 * (everything before Australia), which is the sheet's MBBS-abroad list. It drives
 * a real business rule (see docs/09-Business-Rules.md), so confirm it with the
 * data owner before relying on it in production.
 */
...
export const PROGRAM_LEVELS: string[] = [
  "Masters",
  "MBA",
  "Bachelors",
  "Higher Diploma",
...
export const FIELDS_OF_STUDY: string[] = [
  ...
  "Welding Engineering",
  "Wine Science & Management",
  "Wood & Timber Technology",
  "Youth Work",
  "Zoology"
];

export const START_YEARS: string[] = [
  "2025",
  "2026",
  "2027",
  "2028",
...
export const CURRICULUM_OPTIONS: string[] = [
  "State Board",
  "CBSE",
  "ICSE",
  "NIOS",
...
export const EDUCATION_YEARS: string[] = [
  "2028",
  "2027",
  "2026",
  "2025",
...
export const ENGLISH_EXAM_OPTIONS: string[] = [
  "IELTS",
  "TOEFL (New)",
  "TOEFL (Old)",
  "PTE",
...
export const COMPETITIVE_EXAM_OPTIONS: string[] = [
  "GRE",
  "GMAT (Focus)",
  "GMAT (Classic)"
];
...
export const UNIVERSITY_OPTIONS: string[] = [
  ...
  "Sports University of Haryana[38]",
  "SR University",
